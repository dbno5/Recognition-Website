...
\AddToShipoutPicture*{\includegraphics[width=\paperwidth,height=\paperheight]{images/border_month}}
...
\begin{center}
  \begin{spacing}{7}
    ...
    {\fontfamily{qcs}\fontsize*[Recipient Font Size]*\selectfont *[Recipient Name]*}
  \end{spacing}
\end{center}
...
\begin{table}[h]
  ...
  \begin{tabular} {V{0.20\paperwidth} V{0.20\paperwidth} V{0.20\paperwidth} }       
    ...
    \vspace{0pt}\parbox[b][1cm][b]{5cm}{\includegraphics[width=5cm]{*[Authorizing User Signature]*} \\
    \rule{5cm}{0.4pt} \\
