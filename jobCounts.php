<?php
    $pageTitle = "Jobs per Title";
    include("includes/header.php");
?>

<?php
$address = '"jobCounts.php"';
...
$mysqli = new mysqli("oniddb.cws.oregonstate.edu","hernandv-db","J9RlSghRw6FKvLq8","hernandv-db");
  ...
  $result = $mysqli->query('SELECT Users.JobTitle AS Title, count(Users.UserID) AS numUsers FROM Users GROUP BY Users.JobTitle');
